...
static inline int nand_read(nand_info_t *info, ulong ofs, ulong *len, uchar *buf)
{
	return info->read(info, ofs, *len, (size_t *)len, buf);
}

static inline int nand_write(nand_info_t *info, ulong ofs, ulong *len, uchar *buf)
{
...
struct nand_write_options {
	uchar *buffer;		/* memory block containing image to write */
...
struct nand_read_options {
	uchar *buffer;		/* memory block in which read image is written*/
